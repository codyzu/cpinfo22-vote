  ...
  return (
    <div className="p-3 gap-8 w-full max-w-screen-xl mx-auto font-sans items-center">
      ...
      <div className="w-full bg-gray-500 rounded-lg h-pb dark:bg-gray-700 flex-row text-white">
        ...
        <div
          className={cx(
            'pb-pink items-end rounded-r-lg',
            `w-[${hackathonPercent}%]`,
      ...
      <div className="rounded-lg p-8 shadow-xl border-gray-600 bg-gray-100">
        <div className="grid grid-cols-[auto_1fr] gap-2 gap-x-2">
          <div className="text-2xl font-bold col-span-2 border-b-gray-400 border-b-4 text-center mb-2">
            Results
          </div>
      ...
      {canVote && (
        <div className="rounded-lg p-8 grid grid-cols-1 sm:grid-cols-[1fr_1fr] shadow-xl gap-8 bg-gray-100">
          <div className="text-2xl font-bold sm:col-span-2 border-b-gray-400 border-b-4 text-center">
            Vote
          </div>
          <button
            type="button"
            className="btn-violet min-w-[12rem]"
            onClick={() => {
              console.log('VOTE!');
          ...
          <button
            type="button"
            className="btn-pink min-w-[12rem]"
            onClick={() => {
              void setDoc(doc(db, 'votes', user!.email!), {
                vote: Vote.hackathon,
                email: user!.email,
